...
export default function Footer() {
    ...
    <footer class="bg-gradient-to-r from-slate-800 via-slate-600 to-slate-800 py-2 px-10 font-sans tracking-wide">
      <div class="max-w-2xl mx-auto text-center">
        ...
        <ul class="flex items-center justify-center flex-wrap gap-y-3 gap-x-6 mt-8">
          ...
          <li><a href="https://www.instagram.com/snap__prints/" target='blank'>
      ...
      <ul class="grid max-sm:grid-cols-1 max-lg:grid-cols-2 lg:grid-cols-3 gap-[2em] md:gap-[10em] mt-10">
        <li class="flex items-center">
          ...
          <a href="tel:1805482588" class="text-blue-500 text-sm ml-3">
  ...
  <strong>180-548-2588</strong>
        ...
        <li class="flex items-center">
          ...
          <a href="mailto:info@example.com" class="text-blue-500 text-sm ml-3">
  ...
  <strong>info@example.com</strong>
        ...
        <li class="flex items-center">
          ...
          <Link class="text-blue-500 text-sm ml-3">
            <small class="block">Address</small>
            <strong>Sion Mumbai, India</strong>
          </Link>
        </li>
      </ul>
      ...
      <div class="flex max-md:flex-col gap-4">
        <ul class="flex flex-wrap gap-4">
          <li class="text-sm">
            <Link href='' class='text-blue-500 font-semibold hover:underline'>Terms of Service</Link>
          </li>
          <li class="text-sm">
            <Link href='' class='text-blue-500 font-semibold hover:underline'>Privacy Policy</Link>
          </li>
          <li class="text-sm">
            <Link href='' class='text-blue-500 font-semibold hover:underline'>Security</Link>
          </li>
        </ul>
        <p class='text-sm text-gray-200 md:ml-auto'>© SnapPrints... All rights reserved.</p>
      </div>
    </footer>
  )
}
