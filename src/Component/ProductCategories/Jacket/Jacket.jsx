...
const Jacket = () => {
  const [jackets] = useState(Array.from({ length: 50 }, (_, index) => ({
    id: index + 1,
    title: `Jacket's t-shirt ${index + 1}`,
    image: { src: "https://rukminim2.flixcart.com/image/850/1000/xif0q/jacket/c/u/j/xxl-no-classic-latest-fashion-black-biker-leather-jacket-for-men-original-imagtzbkwz4wjzwb.jpeg?q=20&crop=false", alt: `T-shirt ${index + 1} image` },
    rating: 4.5,
    reviews: 444,
