...
const Sweatshirt = () => {
  const [sweatshirts] = useState(Array.from({ length: 50 }, (_, index) => ({
    id: index + 1,
    title: `Sweatshirt ${index + 1}`,
    image: { src: "https://www.apc.fr/media/catalog/product/c/o/cohbv-m27913tbe_00_1724848617.jpg?width=684&height=789&store=dk_en&image-type=small_image&fit=bounds&canvas=684,789&bg-color=ffffff", alt: `T-shirt ${index + 1} image` },
    rating: 4.5,
    reviews: 444,
