...
const Tshirt = () => {
  const [tshirts] = useState(Array.from({ length: 50 }, (_, index) => ({
    id: index + 1,
    title: `T-shirt ${index + 1}`,
    image: { src: "https://merchshop.in/wp-content/uploads/2019/06/web-designer-t-shirt-navy-blue.jpg", alt: `T-shirt ${index + 1} image` },
    rating: 4.5,
    reviews: 444,
