    ...
    <div class="font-sans my-10">
            <div class="grid items-start grid-cols-1 md:grid-cols-2 p-4 gap-12 max-w-6xl mx-auto">
                <div class="grid grid-cols-2 md:sticky top-0 gap-3">
                    <div>
                        <img src="https://readymadeui.com/images/product6.webp" alt="Product" class="w-full h-full object-cover object-top rounded-md" />
                    </div>
                    <div>
                        <img src="https://readymadeui.com/images/product8.webp" alt="Product" class="w-full h-full object-cover object-top rounded-md" />
                    </div>
                    <div>
                        <img src="https://readymadeui.com/images/product5.webp" alt="Product" class="w-full h-full object-cover object-top rounded-md" />
                    </div>
                    <div>
                        <img src="https://readymadeui.com/images/product7.webp" alt="Product" class="w-full h-full object-cover object-top rounded-md" />
                    </div>
                </div>
                ...
                <div class="max-lg:max-w-2xl">
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-2 mt-4">
                            <button type="button" class="w-10 h-10 bg-gray-800 border border-orange-500 hover:border-orange-500 rounded-full shrink-0"></button>
                            <button type="button" class="w-10 h-10 bg-gray-400 border border-white hover:border-orange-500 rounded-full shrink-0"></button>
                            <button type="button" class="w-10 h-10 bg-orange-400 border border-white hover:border-orange-500 rounded-full shrink-0"></button>
                            <button type="button" class="w-10 h-10 bg-red-400 border border-white hover:border-orange-500 rounded-full shrink-0"></button>
                        </div>
                    </div>
                    ...
                    <div class="mt-8">
                        ...
                        <div class="flex flex-wrap gap-2 mt-4">
                            <button type="button" class="w-10 h-10 border hover:border-orange-500 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">SM</button>
                            <button type="button" class="w-10 h-10 border hover:border-orange-500 border-orange-500 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">MD</button>
                            <button type="button" class="w-10 h-10 border hover:border-orange-500 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">LG</button>
                            <button type="button" class="w-10 h-10 border hover:border-orange-500 font-semibold text-gray-800 text-sm rounded-full flex items-center justify-center shrink-0">XL</button>
                        </div>
                    </div>

                    <div class="mt-8 space-y-4 max-w-xs">
                        <button type="button" class="w-full px-4 py-3 bg-orange-500 hover:bg-orange-600 text-white text-sm font-semibold rounded-md">Buy now</button>
                        <button type="button" class="w-full px-4 py-2.5 border border-orange-500 bg-transparent hover:bg-gray-50 text-gray-800 text-sm font-semibold rounded-md">Add to cart</button>
                    </div>
